// string bir dizi oluşturulur ve bu dizi içerisinde şehirlerin isimleri yer alır.
...
export const CityList = cities.reduce((acc, city) => {
  city.name =
    city.name.charAt(0) + city.name.slice(1).toLocaleLowerCase("tr-TR");
  cityMap.push(city);
  return cityMap;
}, cityMap);
